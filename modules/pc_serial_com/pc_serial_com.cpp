...
void pcSerialComInit()
{
    ...
    pcSerialComStringWrite("*Subsection 11.2.1 test program*\r\n\r\n");
    commandSetWifiComApSsid();
}
...
static void commandRestartWifiCom()
{
    pcSerialComStringWrite( "Wi-Fi communication started, please wait... \r\n\r\n" );
    wifiComRestart();
}

static void commandSetWifiComApSsid()
{
    pcSerialComStringWrite("Please provide the SSID of the Wi-Fi "); 
...
static void commandSetWifiComApPassword()
{
    pcSerialComStringWrite("Please provide the Password of the Wi-Fi "); 
    pcSerialComStringWrite("Access Point and press the Enter key\r\n");
    pcSerialComStringWrite("> ");
